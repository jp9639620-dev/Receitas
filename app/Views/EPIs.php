...
<div class="d-flex">
  <div class="sidebar" style="width: 250px;">
    ...
    <a href="<?= base_url('colaboradores') ?>" class="sidebar-item" style="text-decoration: none; color: inherit;">
      <i class="fas fa-shield-alt"></i> Colaboradores
    </a>
    <a href="<?= base_url('epis') ?>" class="sidebar-item active" style="text-decoration: none; color: inherit;">
  ...
  <div class="flex-grow-1">
    ...
    <div class="main-content">
      <div class="dashboard-header">EPIs</div>
      <div class="card-section">
        <div class="section-title">Gestão de EPIs</div>
        <p>Aqui você pode gerenciar o cadastro de EPIs e consultar validade, quantidade e status dos equipamentos.</p>
      </div>
    </div>
  </div>
</div>
